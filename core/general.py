...
def listDirFiles(rootDir='.', verbose=False):
    listFiles = []
    # listing all files in the dir and subdirs
...
https://github.com/Antidote1911/cryptoshop
"""

#if __name__ == '__main__':
    #print(listDirFiles(sys.argv[1]))
